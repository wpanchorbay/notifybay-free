...
const Wizard: React.FC = () => {
  ...
  const steps: Array<{ title: string; body: React.ReactNode }> = [
    {
      title: __("Welcome to NotifyBay", "notifybay"),
      body: (
    ...
    {
      title: __("Sender identity", "notifybay"),
      body: (
    ...
    {
      title: __("Choose features", "notifybay"),
      body: (
        <ClassicSettingsTable
          fields={[
            {
              ...
              render: () => (
                <ClassicCheckbox
                  ...
                  label={__("Require email confirmation", "notifybay")}
                />
              ),
            },
            ...(isPro
              ? [
                  {
                    ...
                    label: __("Wishlist (Pro)", "notifybay"),
                    render: () => (
                      <ClassicCheckbox
                        ...
                        label={__("Enable Wishlist / price-drop alerts", "notifybay")}
                      />
                    ),
                  },
                ]
    ...
    {
      title: __("Button text", "notifybay"),
      body: (
        <ClassicSettingsTable
          fields={[
            {
              id: "appearance_waitlistButtonText",
              label: __("Waitlist button label", "notifybay"),
              render: () => (
                <>
                  <ClassicInput
    ...
    {
      title: __("Add it to your store", "notifybay"),
      body: (
    ...
    ...(isPro
      ? [
          {
            title: __("Activate your license", "notifybay"),
            body: (
              <div className="notifybay-flex notifybay-flex-col notifybay-gap-[8px]">
                <p className="notifybay-text-gray-600">
                  {__(
                ...
                >
                  {__("Open license settings", "notifybay")}
                </a>
              </div>
            ),
          },
      ...
      : []),
    {
      title: __("You're all set!", "notifybay"),
      body: (
        <p className="notifybay-text-gray-600">
          {__(
  ...
  return (
    <div className="wrap notifybay-wizard">
      <h1>{__("NotifyBay Setup Wizard", "notifybay")}</h1>

      <ol
        className="notifybay-wizard__steps"
        aria-label={__("Setup progress", "notifybay")}
      >
        {steps.map((s, index) => {
          ...
          const status = isActive
            ? __("Current", "notifybay")
            : isComplete
            ? __("Complete", "notifybay")
            : __("Upcoming", "notifybay");
        ...
        <div className="notifybay-wizard__actions">
          ...
          {isLast ? (
            ...
            <button
              ...
              disabled={saving}
            >
              {saving ? __("Saving…", "notifybay") : __("Next", "notifybay")}
            </button>
          )}
        </div>
      </div>
