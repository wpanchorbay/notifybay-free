  ...
  return (
    <>
      <span
        ...
        tabIndex={0}
        className={`notifybay-cursor-help notifybay-inline-flex notifybay-items-center notifybay-justify-center notifybay-w-[16px] notifybay-h-[16px] notifybay-rounded-full notifybay-bg-[#72777c] hover:notifybay-bg-[#50575e] notifybay-text-white notifybay-transition-colors notifybay-ml-1 ${className}`}
      >
